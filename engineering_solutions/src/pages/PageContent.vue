<template>
  <div>
    <AppHeader />
    <AppNavbar />
    <div class="block gas-connection">
      <div class="container">
        <div class="content">
          <h3 id="podcluchenie">Подключение газа</h3>
          <h2>Подключение газа</h2>
          <p>
    ...
    <div class="block legal-entities">
      <div class="container">
        <div class="content">
...
.block {
  ...
  padding: 80px 0;
  display: flex;
  justify-content: center; /* Текст справа */
